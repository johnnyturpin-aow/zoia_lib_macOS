...
This is a native macOS fork of the zoia-lib cross-platform patch manager / librarian for the Empress Effects ZOIA / Euroburo modular effects unit. It is written in Swift/SwiftUI which is currently (and unfortunately) not cross-platform.
...
*A gentle reminder that both this project as well as the parent cross-platform project are currently developed and maintained completely independently from Empress Effects - by developers volunteering their own time.*
